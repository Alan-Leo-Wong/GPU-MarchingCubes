...
inline void MC::initResources(const bool &sdfFlag, const uint3 &resolution,
...
void MC::marching_cubes(const uint3 &resolution, const double3 &gridOrigin,
                        const double3 &gridWidth, const double &isoVal,
  ...
  //   double3 gridOrigin = make_double3(-1, -1, -1); // origin coordinate of
  //   grid
